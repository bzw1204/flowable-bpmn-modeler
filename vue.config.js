...
if (NODE_ENV === 'demo') {
  publicPath = '/flowable-bpmn-modeler/demo/'
  outputDir = 'docs/demo'
  appFileName = 'Demo'
}
if (NODE_ENV === 'cdn') {
  ...
  publicPath = `https://cdn.jsdelivr.net/gh/goldsubmarine/flowable-bpmn-modeler@${version}/docs/cdn/${version}/`
...
module.exports = {
  ...
  chainWebpack: config => {
    ...
    config.when(NODE_ENV !== 'development' && NODE_ENV !== 'build',
      config => {
